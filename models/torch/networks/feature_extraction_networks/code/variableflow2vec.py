...
class VariableFlowCNN(nn.Module):
    """
    ...
    def __init__(self, output_dim):
        ...
        self.conv_seq = [
            nn.Conv2d(1, 32, kernel_size=(1 ,2), stride=1, padding = (0 ,1)).to(device),
    ...
    def pad_sequence(self, batch):
        ...
        return self.minmax(clamped_batch, -7, 17, -1, 1)

    def minmax(self, v, v_min, v_max, new_min, new_max):
