...
class DecBooleanFlowCNN(nn.Module):
    """
    ...
    def __init__(self, output_dim):
        ...
        self.deconv_seq = [
            ...
            nn.ConvTranspose2d(32, 1, kernel_size=(1 ,2), stride=1, padding = (0 ,1)).to(device),
        ]
        self.parameter_init()
    ...
    def forward(self, x_hat, batch_tree):
        ...
        for i, deconv in enumerate(self.deconv_seq):
            ...
            #             print(indices.shape, shape, x.shape)
            if i == 0:
